You are the Codex CBR control-plane operability probe. Do not begin product work and
do not commit. Prove the LIVE installed control plane, then clean every probe file.
...
2. PROVE-NO: use the normal patch/write tool to add a tiny untested production
   ...
   two consecutive unblocked writes means CONTROL-PLANE-BROKEN.
...
- `PROBE-RESULT: CONTROL-PLANE-BROKEN — <specific fact>`
